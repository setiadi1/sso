...
<style type="text/css">
	#permission-group, #permission-input, #permission-name-input {
	...
	<div class="main-content">
		...
		<ul class="nav justify-content-end pb-3">
			<li class="nav-item mr-2">
				<button class="btn-tools btn-tools-height" id="btn_add_permission" type="button" class="btn btn-outline-dark">
...
<!-- Model add new role -->
<div class="modal fade" id="modal_add_permission" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">   
				<form>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="role-input">Permission</label>
						<input type="text" class="form-control" id="permission-input" placeholder="Enter permission">
						</div>
						<div class="col-md-6 mb-3">
							<label for="role-input">Permission name</label>
							<input type="text" class="form-control" id="permission-name-input" placeholder="Enter permission name">
						</div>
					</div>

					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="role-input">Permission group</label>
							<input type="text" class="form-control" id="permission-group" placeholder="Enter permission group">
						</div>
						<div class="col-md-6 mb-3">
				...
				<div class="card">
					<div class="card-body">
						<h6>Petunjuk dan Informasi Menambah Permission</h6>
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<ol>
			...
			<div class="modal-footer">
				<button id="permission-submit" type="submit" class="global-submit-btn btn btn-primary">Submit</button>
			</div>
		</div>
	</div>
</div>
...
<!-- Model add new role -->
<div class="modal fade" id="modal_edit_permission" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title font-weight-bold text-muted"><i class="fas fa-user-cog iconsize2"></i></h5>
			...
			<div class="modal-body">   
				<form>
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="role-input">Permission</label>
						<input type="text" class="form-control" id="edit-permission-input" placeholder="Enter permission">
						</div>
						<div class="col-md-6 mb-3">
							<label for="role-input">Permission name</label>
							<input type="text" class="form-control" id="edit-permission-name-input" placeholder="Enter permission name">
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							<label for="role-input">Permission group</label>
							<input type="text" class="form-control" id="edit-permission-group" placeholder="Enter permission group">
						</div>
						<div class="col-md-6 mb-3">
							<div class="form-group">
								<label for="selectApp">Application</label>
								<br>
								<select id="editSelectApp" single></select>
							</div>
						</div>
			...
			<div class="modal-footer">
				<button id="edit-permission-submit" type="submit" class="global-submit-btn btn btn-primary">Submit</button>
			</div>
		</div>
	</div>
</div>
